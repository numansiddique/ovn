...
static ENGINE_NODE_WITH_CLEAR_TRACK_DATA(lr_lb_data, "lr_lb_data");
                          ...
                          struct ovsdb_idl_loop *sb)
{
    ...
    engine_add_input(&en_lr_lb_data, &en_northd, lr_lb_data_northd_handler);
    engine_add_input(&en_lr_lb_data, &en_lb_data, lr_lb_data_lb_data_handler);
    engine_add_input(&en_lr_lb_data, &en_lr_nat, lr_lb_data_lr_nat_handler);
    ...
    engine_add_input(&en_lflow, &en_lr_lb_data, NULL);
    ...
    engine_add_input(&en_sync_to_sb_addr_set, &en_lr_lb_data, NULL);
    ...
    engine_add_input(&en_sync_to_sb_pb, &en_lr_lb_data, NULL);
