...
en_sync_to_sb_addr_set_run(struct engine_node *node, void *data OVS_UNUSED)
{
    ...
    const struct ed_type_lr_lb_data *lr_lb_data =
        engine_get_input_data("lr_lb_data", node);
...
en_sync_to_sb_pb_run(struct engine_node *node, void *data OVS_UNUSED)
{
    ...
    struct ed_type_lr_lb_data *lr_lb_data =
        engine_get_input_data("lr_lb_data", node);
               ...
               const struct lr_lb_data_table *lr_lbs)
{
    ...
    LR_LB_DATA_TABLE_FOR_EACH (lrlb_rec, lr_lbs) {
