                                           ...
                                           void *data OVS_UNUSED)
{
    ...
    NBREC_LOAD_BALANCER_GROUP_TABLE_FOR_EACH_TRACKED (tracked_lb_group,
        ...
        } else if (nbrec_load_balancer_group_is_updated(
                tracked_lb_group, NBREC_LOAD_BALANCER_GROUP_COL_LOAD_BALANCER)) {
          ...
          struct hmap *lbs, struct hmap *lb_groups)
{
    ...
    NBREC_LOAD_BALANCER_GROUP_TABLE_FOR_EACH (nbrec_lb_group, nbrec_lb_group_table) {
