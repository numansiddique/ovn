...
struct ed_type_ls_stateful {
    struct ls_stateful_table ls_sful_table;

    bool tracked;
    struct ls_stateful_tracked_data tracked_data;
};
...
bool ls_stateful_logical_switch_handler(struct engine_node *, void *data);
