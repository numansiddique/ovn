...
OVSIDL_BUILT += \
	lib/ovn-pr-idl.c \
	lib/ovn-pr-idl.h \
	lib/ovn-pr-idl.ovsidl
EXTRA_DIST += lib/ovn-pr-idl.ann
OVN_PR_IDL_FILES = \
	$(srcdir)/ovn-pr.ovsschema \
	$(srcdir)/lib/ovn-pr-idl.ann
lib/ovn-pr-idl.ovsidl: $(OVN_PR_IDL_FILES)
	$(AM_V_GEN)$(OVSDB_IDLC) annotate $(OVN_PR_IDL_FILES) > $@.tmp && \
	mv $@.tmp $@
