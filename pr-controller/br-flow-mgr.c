...
void
br_flow_add_logical_oflow(const char *bridge, uint8_t table_id, uint16_t priority,
                          uint64_t cookie, const struct match *match,
                          const struct ofpbuf *actions,
                          const struct uuid *flow_uuid)
{
...
void
br_flow_add_physical_oflow(const char *bridge, uint8_t table_id, uint16_t priority,
                           uint64_t cookie, const struct match *match,
                           const struct ofpbuf *actions,
                           const struct uuid *flow_uuid)
{
...
void
br_flow_remove_physical_oflows(const char *bridge, const struct uuid *flow_uuid)
{
    struct br_flow_table *br_ftable = br_flow_table_get(bridge);
    if (br_ftable) {
